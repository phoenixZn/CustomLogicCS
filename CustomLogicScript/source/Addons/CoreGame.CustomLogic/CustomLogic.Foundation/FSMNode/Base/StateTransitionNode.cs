...
namespace CoreGame.Custom
{
    ...
    public class StateTransitionNodeCfg : ICustomNodeXmlCfg
    {
        ...
        {
            ConditionCfg = ICustomNodeXmlCfg.CreateNodeCfg(xmlNode.SelectSingleNode("Condition"));
    ...
    public class StateTransitionNode : CustomNode, INeedUpdate
    {
        ...
        public override void InitializeNode(ICustomNodeCfg cfg, CustomNodeContext context)
        {
            ...
            mConditionNode = mContext.NodeFactory.CreateCustomNode(theCfg.ConditionCfg, context) as ConditionNodeBase;
        ...
        {
            mContext.NodeFactory.DestroyCustomNode(mConditionNode);
            mConditionNode = null;
